...
const handleDelete = (id: string) => {
  if (confirm('Are you sure you want to delete this book?')) {
    Inertia.delete(route('books.destroy', id));  // Laravel route for deletion
  }
};

// Function to trigger editing the book
...
<template>
  <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-105">
    ...
    <div class="p-4">
      ...
      <p class="text-sm text-gray-500 mt-1">Published: {{ book.publishedYear }}</p>
